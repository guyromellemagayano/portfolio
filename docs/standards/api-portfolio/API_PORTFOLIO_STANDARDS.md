...
This document defines standards for `apps/api-portfolio` as the portfolio-focused API boundary for the monorepo.
...
3. Avoid importing `apps/web` code into `apps/api-portfolio`; cross-app dependencies should happen through packages only.
