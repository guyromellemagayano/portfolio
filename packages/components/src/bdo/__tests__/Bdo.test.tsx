...
it("renders synchronously with standard props", async () => {
  render(
    <Bdo data-testid="bdo-element">Synchronous bidirectional override</Bdo>
  );

  // Renders the bdo immediately
  const bdo = screen.getByTestId("bdo-element");
  expect(bdo.tagName).toBe("BDO");
  expect(bdo).toHaveTextContent("Synchronous bidirectional override");
...
it("renders repeated synchronous usage with standard props", async () => {
  render(<Bdo data-testid="bdo-element">Repeated bidirectional override</Bdo>);

  // Renders the bdo immediately
  const bdo = screen.getByTestId("bdo-element");
  expect(bdo.tagName).toBe("BDO");
  expect(bdo).toHaveTextContent("Repeated bidirectional override");
...
it("renders with extended custom attributes", () => {
  render(
    <Bdo
      data-testid="bdo-element"
      id="custom-bdo-id"
