...
it("renders synchronously with standard props", async () => {
  render(<Article data-testid="article-element">Synchronous article</Article>);

  // Renders the article immediately
  const article = screen.getByTestId("article-element");
  expect(article.tagName).toBe("ARTICLE");
  expect(article).toHaveTextContent("Synchronous article");
...
it("renders repeated synchronous usage with standard props", async () => {
  render(<Article data-testid="article-element">Repeated article</Article>);

  // Renders the article immediately
  const article = screen.getByTestId("article-element");
  expect(article.tagName).toBe("ARTICLE");
  expect(article).toHaveTextContent("Repeated article");
...
it("renders with extended article-specific attributes", () => {
  render(
    <Article
      data-testid="article-element"
      className="article-content"
