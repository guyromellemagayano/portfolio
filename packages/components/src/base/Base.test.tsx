...
it("renders synchronously with standard props", async () => {
  render(<Base data-testid="base-element" href="/client-base" />);

  // Renders the base immediately
  const base = screen.getByTestId("base-element");
  expect(base.tagName).toBe("BASE");
...
it("renders repeated synchronous usage with standard props", async () => {
  render(<Base data-testid="base-element" href="/repeated-base" />);

  // Renders the base immediately
  const base = screen.getByTestId("base-element");
  expect(base.tagName).toBe("BASE");
  expect(base).toHaveAttribute("href", "/repeated-base");
