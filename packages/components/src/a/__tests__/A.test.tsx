...
it("renders synchronously with standard props", async () => {
  render(
    <A data-testid="link-element" href="/standard-page">
      Synchronous link
    </A>
  );

  // Renders the link immediately
  const link = screen.getByTestId("link-element");
  expect(link.tagName).toBe("A");
  expect(link).toHaveTextContent("Synchronous link");
  expect(link).toHaveAttribute("href", "/standard-page");
...
it("renders repeated synchronous usage with standard props", async () => {
  render(
    <A data-testid="link-element" href="/repeated-page">
      Repeated link
    </A>
  );
  ...
  const link = screen.getByTestId("link-element");
  expect(link.tagName).toBe("A");
  expect(link).toHaveTextContent("Repeated link");
  expect(link).toHaveAttribute("href", "/repeated-page");
