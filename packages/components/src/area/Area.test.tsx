...
it("renders synchronously with standard props", async () => {
  render(<Area data-testid="area-element" coords="0,0,200,200" shape="poly" />);

  // Renders the area immediately
  const area = screen.getByTestId("area-element");
  expect(area.tagName).toBe("AREA");
...
it("renders repeated synchronous usage with standard props", async () => {
  render(<Area data-testid="area-element" coords="0,0,150,150" shape="rect" />);
