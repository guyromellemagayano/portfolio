...
// prop test
it("renders client component with standard props", () => {
  render(
    <Blockquote data-testid="blockquote-element">
      Synchronous quote content
    </Blockquote>
  );
  const blockquote = screen.getByTestId("blockquote-element");
  expect(blockquote.tagName).toBe("BLOCKQUOTE");
  expect(blockquote).toHaveTextContent("Synchronous quote content");
});

// prop test
it("renders standard component with standard props", () => {
  render(
    <Blockquote data-testid="blockquote-element">
      Repeated quote content
    </Blockquote>
  );
  const blockquote = screen.getByTestId("blockquote-element");
  expect(blockquote.tagName).toBe("BLOCKQUOTE");
  expect(blockquote).toHaveTextContent("Repeated quote content");
});
