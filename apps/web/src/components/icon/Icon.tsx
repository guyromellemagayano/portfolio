...
import { Svg, SvgProps, type SvgRef } from "@guyromellemagayano/components";
...
type CommonIconComponent = React.ForwardRefExoticComponent<
  IconProps & React.RefAttributes<IconRef>
>;
type IconComponent = CommonIconComponent & {
  X: CommonIconComponent;
...
/** X (Twitter) icon. */
const XIcon = React.forwardRef<IconRef, IconProps>(function XIcon(props, ref) {
  const { ...rest } = props;
...
/** Instagram icon. */
const InstagramIcon = React.forwardRef<IconRef, IconProps>(
...
/** LinkedIn icon. */
const LinkedInIcon = React.forwardRef<IconRef, IconProps>(
...
/** GitHub icon. */
const GitHubIcon = React.forwardRef<IconRef, IconProps>(
