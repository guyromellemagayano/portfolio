...
describe("SectionContent", () => {
  ...
  describe("Basic Rendering", () => {
    it("renders children correctly", () => {
      render(
        <SectionContent data-testid="custom-id-section-content">
          <p>Test content</p>
        </SectionContent>
      );
    ...
    it("applies custom className", () => {
      render(
        <SectionContent
          ...
          data-testid="custom-id-section-content"
        >
          Content
        </SectionContent>
      );
      ...
      const content = screen.getByTestId("section-content");
      expect(content).toHaveClass("md:col-span-3", "custom-class");
    });
  ...
  describe("Component Structure Tests", () => {
    ...
    it("applies correct CSS classes", () => {
      ...
      const content = screen.getByTestId("section-content");
      expect(content).toHaveClass("md:col-span-3");
    });
  ...
  describe("Ref Forwarding Tests", () => {
    it("forwards ref correctly", () => {
      ...
      render(
        <SectionContent ref={ref} data-testid="custom-id-section-content">
          Content
        </SectionContent>
      );
  ...
  describe("Accessibility Tests", () => {
    ...
    it("has correct data attributes for debugging", () => {
      ...
      expect(content).toHaveAttribute("data-testid", "section-content");
    });
  });
