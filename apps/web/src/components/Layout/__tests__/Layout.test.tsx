...
describe("SimpleLayout", () => {
  describe("Basic Rendering", () => {
    ...
    it("renders skip link with i18n aria-label", () => {
      render(
  ...
  describe("Content Validation", () => {
    ...
    it("renders when only children provided (title and intro empty)", () => {
      ...
      expect(screen.getByRole("main")).toHaveTextContent("Body only");
    });
  });
...
describe("ArticleLayout", () => {
  ...
  describe("Back button and ARIA", () => {
    it("renders back button with i18n aria-label when previousPathname is set", () => {
      render(
