...
describe("Layout Integration Tests", () => {
  ...
  describe("SimpleLayout with header and main", () => {
    it("renders SimpleLayout with title, intro, and main content", () => {
      render(
    ...
    it("renders complete page with title, intro, and main content", () => {
      const mockContent = (
        <div>
          <h2>Page Content</h2>
    ...
    it("works with blog post content in main", () => {
      const blogContent = (
        <article>
          <div>
  ...
  describe("ArticleLayout with article, back button, and context", () => {
    const mockArticle = {
    ...
    it("renders ArticleLayout with article landmark, heading, time, prose and back button when previousPathname set", () => {
      render(
    ...
    it("renders ArticleLayout without back button when previousPathname not set", () => {
      render(
        <ArticleLayout article={mockArticle}>
          <p>Body</p>
        </ArticleLayout>
      ...
      expect(screen.getByRole("article")).toBeInTheDocument();
      expect(
        screen.queryByRole("button", { name: "Go back to articles" })
