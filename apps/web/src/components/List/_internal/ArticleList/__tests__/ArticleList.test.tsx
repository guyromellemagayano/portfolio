...
vi.mock("../ArticleList.module.css", () => ({
  default: {
    ...
    articleListChildren: "articleListChildren",
  },
}));
...
describe("ArticleList", () => {
  ...
  describe("Component Structure", () => {
    it("applies correct CSS classes", () => {
      ...
      const container = screen.getByTestId("test-id-article-list-root");
      expect(container).toHaveClass("articleList");
    });
    ...
    it("combines CSS module + custom classes", () => {
      ...
      const container = screen.getByTestId("test-id-article-list-root");
      expect(container).toHaveClass("articleList", "custom-class");
    });
    ...
    it("renders children wrapper with correct class", () => {
      ...
      const childrenWrapper = screen
        ...
        .querySelector(".articleListChildren") as HTMLElement;
      expect(childrenWrapper).toBeInTheDocument();
      expect(childrenWrapper).toHaveClass("articleListChildren");
    });
  });
