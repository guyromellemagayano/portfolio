...
describe("ArticleListItem", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("passes through HTML attributes", () => {
      ...
      const wrapperArticle = screen.getByTestId(
        "test-id-article-item-root"
      ).parentElement;
      expect(wrapperArticle).toHaveAttribute("aria-label", "Article item");
    });
  });
  ...
  describe("Front Page Rendering", () => {
    it("renders with wrapper article when isFrontPage is false", () => {
      ...
      // The wrapper article should have the CSS class
      const wrapperArticle = screen.getByTestId(
        "test-id-article-item-root"
      ).parentElement;
      expect(wrapperArticle).toHaveClass("articleListItem");

      // The inner Card should have the test ID
      const cardElement = screen.getByTestId("test-id-article-item-root");
    ...
    it("renders without wrapper article when isFrontPage is true", () => {
      ...
      // Should not have a wrapper with articleListItem class
      const wrapperArticle = cardElement.parentElement;
      expect(wrapperArticle).not.toHaveClass("articleListItem");
    });
  ...
  describe("Performance", () => {
    ...
    it("handles isFrontPage prop changes efficiently", () => {
      ...
      expect(
        screen.getByTestId("test-id-article-item-root")
      ).toBeInTheDocument();
  ...
  describe("Accessibility", () => {
    ...
    it("supports role attribute", () => {
      ...
      expect(wrapperArticle).toHaveAttribute("role", "listitem");
    });
  });
  ...
  describe("Integration", () => {
    ...
    it("maintains proper DOM structure when not on front page", () => {
      ...
      expect(wrapperArticle).toContainElement(cardElement);
